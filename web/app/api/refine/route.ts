...
function buildRefinePrompt(sceneGraph: SceneGraph, selectionLines: string[], userPrompt?: string) {
  const lockNotes = [
...
export async function POST(req: NextRequest) {
  ...
  const prompt = buildRefinePrompt(sceneGraph, selectionLines, userPrompt);
