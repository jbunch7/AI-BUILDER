...
export function WizardProvider({ children }: { children: React.ReactNode }) {
  ...
  const refineMasks = useCallback(
    async (types: SceneElementType[]) => {
      ...
      // Deduplicate and only skip types that already have PREMIUM (mask-service) masks.
      // Polygon-raster masks exist for most types immediately after scan and should still be refined.
